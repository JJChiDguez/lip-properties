...
def main():
    ...
    if main.count == 1:
        print(f'\n# n:     \t{n}')
        print(f'# Oracle:\tTQFP oracle as in Lemma 2 (optimized according to Remark 7)')
    ...
    recovered_u = algorithm(q, n, s, function, (oracle_call, second_oracle_call), optimized=True, Recover=Recover)
